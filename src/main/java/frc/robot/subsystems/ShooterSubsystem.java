...
final TalonFX m_motorLeft = new TalonFX(0);
  ...
  private SmartMotorController talonSmartMotorController = new TalonFXWrapper(m_motorLeft, DCMotor.getNEO(1), smcConfig);
  ...
  // Shooter Mechanism
  private FlyWheel shooter = new FlyWheel(shooterConfig, talonSmartMotorController);
